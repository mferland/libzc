...
unsigned int pwstream_get_start_idx(struct pwstream *pws, unsigned int stream, unsigned int pos);
unsigned int pwstream_get_stop_idx(struct pwstream *pws, unsigned int stream, unsigned int pos);
